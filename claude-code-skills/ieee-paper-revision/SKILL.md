...
- [Response Letter Format Specification](references/response-letter-format.md) - Complete formatting specification for response letters including all LaTeX patterns, per-reviewer section setup, figure/table counter prefixes, response writing depth guide, and acknowledgment sentence variations
- [Revision Workflow Details](references/revision-workflow.md) - Detailed step-by-step workflow with common scenarios (adding derivations, new experiments, notation fixes, assumption justifications)
